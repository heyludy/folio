...
import {Plus,Eye,ArrowLeft,Download,Check,GripVertical,X,Palette,ContactRound,Monitor,Tablet,Smartphone,FileText,Globe,History} from 'lucide-react';
...
function App({account,onLogout}){
 ...
 const applyPrepared=async next=>{
 ...
 return <div className="studio"><div className="studio-background" inert={!!(preparing||publishing||importBusy||historySite)||undefined} aria-hidden={!!(preparing||publishing||importBusy||historySite)||undefined}>

...
function App({account,onLogout}){
 ...
 const editReviewIssue=issue=>{
  ...
  if(issue.sectionId){setSelected(issue.sectionId);setPendingNavigation({siteId:site.id,lang:issue.lang,sectionId:issue.sectionId,field:issue.field,focus:true})}
 ...
 return <div className="studio"><div className="studio-background" inert={!!(preparing||publishing||importBusy||historySite||reviewing)||undefined} aria-hidden={!!(preparing||publishing||importBusy||historySite||reviewing)||undefined}>

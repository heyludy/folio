...
export function ProjectHome({sites,deleted=[],publications={},onOpen,onPublish,onCheckLink,onLink,onCreate,onDelete,onRestore,onDuplicate,onHistory,actionsDisabled=false,activity={},statuses={}}){
 ...
 return <main className="project-home"><div className="project-heading"><div><h1>프로젝트<span>{sites.length}</span></h1><p>교수님의 연구와 이야기를 한 페이지에.</p></div><button className="studio-button primary" onClick={onCreate}><Plus size={16}/>새 프로젝트</button></div>

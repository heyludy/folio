  ...
  {!loaded?<p className="prepare-loading" role="status">준비 중인 자료를 불러오는 중…</p>:<>
   ...
   <div className="prepare-body" inert={applying||undefined}>
    ...
    {draft.step==='review'&&<>
     ...
     <p className="prepare-note">이름·소속·이메일은 연결된 위치에도 반영돼요. {site.setup?.stage==='content'?'다음 단계에서 프로필 사진과 CV를 넣을 수 있어요.':'사진과 PDF는 페이지에서 올릴 수 있어요.'}</p>
    </>}
